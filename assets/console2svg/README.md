# console2svg — recording assets

- **Family:** hybrid (scripted tape + interactive live capture)
- **Modes:** interactive + scripted
- **Formats:** svg · gif · mp4 · webm
- **Converter:** ffmpeg
- **Upstream:** https://github.com/arika0093/console2svg
...
- [`linux-bash-typing-demo.svg`](svg/linux-bash-typing-demo.svg)
- [`linux-pwsh-help-tour.svg`](svg/linux-pwsh-help-tour.svg)
- [`linux-pwsh-launch-exit.svg`](svg/linux-pwsh-launch-exit.svg)
- [`linux-pwsh-tui-splash.svg`](svg/linux-pwsh-tui-splash.svg)
- [`linux-pwsh-typing-demo.svg`](svg/linux-pwsh-typing-demo.svg)
- [`linux-zsh-help-tour.svg`](svg/linux-zsh-help-tour.svg)
- [`linux-zsh-launch-exit.svg`](svg/linux-zsh-launch-exit.svg)
- [`linux-zsh-tui-splash.svg`](svg/linux-zsh-tui-splash.svg)
...
- [`windows-pwsh-typing-demo.webm`](webm/windows-pwsh-typing-demo.webm)

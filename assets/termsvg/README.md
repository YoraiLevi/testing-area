# termsvg — recording assets

- **Family:** interactive (live TTY session)
- **Modes:** interactive
- **Formats:** cast · svg · gif · webm
- **Converter:** ffmpeg
- **Upstream:** https://github.com/mrmarble/termsvg
...
- [`macos-zsh-help-tour.cast`](cast/macos-zsh-help-tour.cast)
- [`macos-zsh-launch-exit.cast`](cast/macos-zsh-launch-exit.cast)
- [`macos-zsh-tui-splash.cast`](cast/macos-zsh-tui-splash.cast)

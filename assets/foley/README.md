# Foley — recording assets

- **Family:** scripted (tape / guided)
- **Modes:** scripted
- **Formats:** gif · mp4 · webm · webp · cast
- **Converter:** none (native encoder)
- **Upstream:** https://github.com/GH-Jaider/foley
...
![Foley mp4 sample: linux-bash-help-tour.mp4](mp4/linux-bash-help-tour.mp4)
...
![Foley webm sample: linux-bash-help-tour.webm](webm/linux-bash-help-tour.webm)
...
![Foley cast sample: linux-bash-help-tour.cast](cast/linux-bash-help-tour.cast)
...
- [`linux-pwsh-tui-splash.cast`](cast/linux-pwsh-tui-splash.cast)
...
- [`linux-zsh-typing-demo.cast`](cast/linux-zsh-typing-demo.cast)

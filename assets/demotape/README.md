# Demo Tape — recording assets

- **Family:** scripted (tape / guided)
- **Modes:** scripted
- **Formats:** gif · mp4 · webm · avi
- **Converter:** ffmpeg
- **Upstream:** https://github.com/fnando/demotape

Files are named `<cell>-<scenario>.<ext>` within each format directory.

## `gif` — 12 file(s)

![Demo Tape gif sample: linux-bash-help-tour.gif](gif/linux-bash-help-tour.gif)
...
![Demo Tape mp4 sample: linux-bash-help-tour.mp4](mp4/linux-bash-help-tour.mp4)
...
![Demo Tape webm sample: linux-bash-help-tour.webm](webm/linux-bash-help-tour.webm)
...
![Demo Tape avi sample: linux-bash-help-tour.avi](avi/linux-bash-help-tour.avi)

- [`linux-bash-help-tour.avi`](avi/linux-bash-help-tour.avi)
- [`linux-bash-launch-exit.avi`](avi/linux-bash-launch-exit.avi)
- [`linux-bash-tui-splash.avi`](avi/linux-bash-tui-splash.avi)
- [`linux-bash-typing-demo.avi`](avi/linux-bash-typing-demo.avi)
- [`linux-zsh-help-tour.avi`](avi/linux-zsh-help-tour.avi)
- [`linux-zsh-launch-exit.avi`](avi/linux-zsh-launch-exit.avi)
- [`linux-zsh-tui-splash.avi`](avi/linux-zsh-tui-splash.avi)
- [`linux-zsh-typing-demo.avi`](avi/linux-zsh-typing-demo.avi)
- [`macos-zsh-help-tour.avi`](avi/macos-zsh-help-tour.avi)
- [`macos-zsh-launch-exit.avi`](avi/macos-zsh-launch-exit.avi)
- [`macos-zsh-tui-splash.avi`](avi/macos-zsh-tui-splash.avi)
- [`macos-zsh-typing-demo.avi`](avi/macos-zsh-typing-demo.avi)

...
|------|--------|:--:|:--:|:--:|:--:|:--:|
| [VHS][vhs]<br><sub>gif · mp4 · webm</sub> | hybrid | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565017) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565017) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565017) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565017) | [➖](https://github.com/YoraiLevi/testing-area/actions/runs/35528565017)<sup>1</sup> |
| [console2svg][console2svg]<br><sub>svg · gif · mp4 · webm</sub> | hybrid | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564948) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564948) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564948) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564948) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564948) |
| [Foley][foley]<br><sub>gif · mp4 · webm · webp · cast</sub> | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565014) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565014) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565014) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528565014) | ➖<sup>2</sup> |
| [Betamax (joshka)][betamax]<br><sub>gif · webp · mp4 · webm</sub> | scripted | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474667)<sup>3</sup> | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474667)<sup>4</sup> | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474667)<sup>5</sup> | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474667)<sup>6</sup> | ➖<sup>7</sup> |
| [EVP][evp]<br><sub>gif · svg · svgz</sub> | hybrid | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35533474545) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35533474545) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35533474545) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35533474545) | ➖<sup>8</sup> |
| [Demo Tape][demotape]<br><sub>gif · mp4 · webm · avi</sub> | scripted | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474632)<sup>9</sup> | ➖<sup>10</sup> | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474632)<sup>11</sup> | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35533474632)<sup>12</sup> | ➖<sup>13</sup> |
| [asciinema + agg][asciinema]<br><sub>cast · gif</sub> | hybrid | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564961) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564961) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564961) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564961) | ➖<sup>14</sup> |
| [PowerSession-rs + agg][powersession]<br><sub>cast · gif</sub> | hybrid | ➖<sup>15</sup> | ➖<sup>16</sup> | ➖<sup>17</sup> | ➖<sup>18</sup> | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35533474657) |
| [Terminalizer][terminalizer]<br><sub>yml · gif</sub> | hybrid | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35529650511) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35529650511) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35529650511) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35529650511) | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35529650511)<sup>19</sup> |
| [acast][acast]<br><sub>cast · gif</sub> | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564978) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564978) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564978) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564978) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564978) |
| [termsvg][termsvg]<br><sub>cast · svg · gif · webm</sub> | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564994) | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35528564994)<sup>20</sup> | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564994) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35528564994) | ➖<sup>21</sup> |
...
3. **Betamax (joshka) · `linux-bash`** — no valid GIF produced in CI
4. **Betamax (joshka) · `linux-pwsh`** — no valid GIF produced in CI
5. **Betamax (joshka) · `linux-zsh`** — no valid GIF produced in CI
6. **Betamax (joshka) · `macos-zsh`** — no valid GIF produced in CI
7. **Betamax (joshka) · `windows-pwsh`** — Betamax builds on libghostty-vt-sys, which has no Windows native build (unsupported upstream).
8. **EVP · `windows-pwsh`** — EVP ships Linux and macOS binaries only; there is no Windows build.
9. **Demo Tape · `linux-bash`** — no valid GIF produced in CI
10. **Demo Tape · `linux-pwsh`** — Demo Tape's --shell flag accepts only bash, zsh, or fish; PowerShell is not a supported shell.
11. **Demo Tape · `linux-zsh`** — no valid GIF produced in CI
12. **Demo Tape · `macos-zsh`** — no valid GIF produced in CI
13. **Demo Tape · `windows-pwsh`** — Demo Tape captures through ttyd, which is Unix-only; there is no Windows recording path.
14. **asciinema + agg · `windows-pwsh`** — The asciinema CLI is Unix-only; Windows capture is out of scope (PowerSession-rs is the Windows-native alternative).
15. **PowerSession-rs + agg · `linux-bash`** — PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
16. **PowerSession-rs + agg · `linux-pwsh`** — PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
17. **PowerSession-rs + agg · `linux-zsh`** — PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
18. **PowerSession-rs + agg · `macos-zsh`** — PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
19. **Terminalizer · `windows-pwsh`** — terminalizer is installed and its CLI runs and the config is found and passed, but 'record' fails on Windows with a blank-path ENOENT ('File not found') when spawning the pty recording session headlessly; no valid GIF produced
20. **termsvg · `linux-pwsh`** — no valid GIF produced in CI
21. **termsvg · `windows-pwsh`** — termsvg's record command imports syscall.SIGWINCH (POSIX-only); the record subcommand does not compile on Windows.
...
|------|-------------------------------------------|
| `linux-bash` | [acast][acast] (4/4), [asciinema + agg][asciinema] (4/4), [console2svg][console2svg] (4/4), [EVP][evp] (4/4), [Foley][foley] (4/4), [Terminalizer][terminalizer] (4/4), [termsvg][termsvg] (4/4), [VHS][vhs] (4/4) |
| `linux-pwsh` | [asciinema + agg][asciinema] (4/4), [console2svg][console2svg] (4/4), [EVP][evp] (4/4), [Foley][foley] (4/4), [Terminalizer][terminalizer] (4/4), [VHS][vhs] (4/4), [acast][acast] (2/4) |
| `linux-zsh` | [acast][acast] (4/4), [asciinema + agg][asciinema] (4/4), [console2svg][console2svg] (4/4), [EVP][evp] (4/4), [Foley][foley] (4/4), [Terminalizer][terminalizer] (4/4), [termsvg][termsvg] (4/4), [VHS][vhs] (4/4) |
| `macos-zsh` | [acast][acast] (4/4), [asciinema + agg][asciinema] (4/4), [console2svg][console2svg] (4/4), [EVP][evp] (4/4), [Foley][foley] (4/4), [Terminalizer][terminalizer] (4/4), [termsvg][termsvg] (4/4), [VHS][vhs] (4/4) |
...
**Partial coverage (working / declared cell-scenarios):** [acast][acast] (17/20), [Terminalizer][terminalizer] (16/20), [termsvg][termsvg] (12/16), [VHS][vhs] (16/20).

**No working GIF in CI (honest skip/broken):** [Betamax (joshka)][betamax], [Demo Tape][demotape].


### Recordings (per tool: minimal + creative)

**Jump to a recording:** [VHS](#rec-vhs) · [console2svg](#rec-console2svg) · [Foley](#rec-foley) · [EVP](#rec-evp) · [asciinema + agg](#rec-asciinema) · [PowerSession-rs + agg](#rec-powersession) · [Terminalizer](#rec-terminalizer) · [acast](#rec-acast) · [termsvg](#rec-termsvg)

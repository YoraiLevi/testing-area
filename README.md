...
|------|--------|:--:|:--:|:--:|:--:|:--:|
| [VHS][vhs] | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370193) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370193) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370193) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370193) | [➖](https://github.com/YoraiLevi/testing-area/actions/runs/35444370193)[^cell-vhs-windows-pwsh] |
| [console2svg][console2svg] | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370150) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370150) | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370150) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370150) |
| [Foley][foley] | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370151) | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370151) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370151) | ➖[^na-foley-windows-pwsh] |
| [Betamax (joshka)][betamax] | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370169) | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370169) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370169) | ➖[^na-betamax-windows-pwsh] |
| [EVP][evp] | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370132) | ⬜ | ⬜ | ⬜ | ➖[^na-evp-windows-pwsh] |
| [Demo Tape][demotape] | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370143) | ⬜ | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370143) | ➖[^na-demotape-windows-pwsh] |
| [asciinema + agg][asciinema] | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370142) | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370142) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370142) | ➖[^na-asciinema-windows-pwsh] |
| [PowerSession-rs + agg][powersession] | interactive | ➖[^na-powersession-linux-bash] | ➖[^na-powersession-linux-pwsh] | ➖[^na-powersession-linux-zsh] | ➖[^na-powersession-macos-zsh] | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35444370149)[^cell-powersession-windows-pwsh] |
| [Terminalizer][terminalizer] | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370157) | ⬜ | ⬜ | ⬜ | ⬜ |
| [acast][acast] | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370187) | ⬜ | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370187) | [❌](https://github.com/YoraiLevi/testing-area/actions/runs/35444370187)[^cell-acast-windows-pwsh] |
| [termsvg][termsvg] | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370137) | ⬜ | ⬜ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35444370137) | ⬜ |
...
[^na]: **Not applicable (➖).** The recorder cannot target this OS/shell: the upstream project publishes no build for it, or a hard dependency is platform-specific (ttyd and libghostty-vt are Unix-only; PowerSession-rs is Windows-only). Cells with a specific cause carry their own footnote.
[^ne]: **Not evaluated (⬜).** This OS/shell was outside the sampled matrix for this recorder. The shell axis (bash/zsh/pwsh) was sampled rather than run exhaustively, so the tool may still work here; no CI run exists, so no verdict is claimed.
[^cell-acast-windows-pwsh]: **acast — `windows-pwsh`:** acast v0.4.0 record panics on the headless windows-pwsh runner (nil pointer dereference at asciicast/recorder.go:28 -- ConPTY has no attached interactive console to size); the binary itself runs (acast version and agg --version succeed). See run logs.
...
[^cell-vhs-windows-pwsh]: **VHS — `windows-pwsh`:** VHS records via ttyd, which has no Windows build (Unix-only); the capture pipeline cannot run on Windows.
[^na-asciinema-windows-pwsh]: **asciinema + agg — `windows-pwsh`:** The asciinema CLI is Unix-only; Windows capture is out of scope (PowerSession-rs is the Windows-native alternative).
[^na-betamax-windows-pwsh]: **Betamax (joshka) — `windows-pwsh`:** Betamax builds on libghostty-vt-sys, which has no Windows native build (unsupported upstream).
[^na-demotape-windows-pwsh]: **Demo Tape — `windows-pwsh`:** Demo Tape captures through ttyd, which is Unix-only; there is no Windows recording path.
[^na-evp-windows-pwsh]: **EVP — `windows-pwsh`:** EVP ships Linux and macOS binaries only; there is no Windows build.
[^na-foley-windows-pwsh]: **Foley — `windows-pwsh`:** Foley builds on libghostty-vt, which has no Windows native build (Unix-only).
[^na-powersession-linux-bash]: **PowerSession-rs + agg — `linux-bash`:** PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
[^na-powersession-linux-pwsh]: **PowerSession-rs + agg — `linux-pwsh`:** PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
[^na-powersession-linux-zsh]: **PowerSession-rs + agg — `linux-zsh`:** PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.
[^na-powersession-macos-zsh]: **PowerSession-rs + agg — `macos-zsh`:** PowerSession-rs is a Windows-only recorder (Win32 ConPTY); it does not run on Unix.

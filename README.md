...
| console2svg | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572393) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572393) | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572393) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572393) |
| Foley | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572375) | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572375) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572375) | ➖ |
| Betamax (joshka) | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572381) | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572381) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572381) | ➖ |
| EVP | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572345) | ➖ | ➖ | ➖ | ➖ |
| Demo Tape | scripted | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572347) | ➖ | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572347) | ➖ |
| asciinema + agg | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572318) | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572318) | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572318) | ➖ |
| PowerSession-rs + agg | interactive | ➖ | ➖ | ➖ | ➖ | [➖](https://github.com/YoraiLevi/testing-area/actions/runs/35438572361) |
| Terminalizer | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572341) | ➖ | ➖ | ➖ | ➖ |
| acast | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572333) | ➖ | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572333) | [➖](https://github.com/YoraiLevi/testing-area/actions/runs/35438572333) |
| termsvg | interactive | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572384) | ➖ | ➖ | [✅](https://github.com/YoraiLevi/testing-area/actions/runs/35438572384) | ➖ |
...
|------|-------------------------------------------|
| `linux-bash` | acast (4/4), asciinema + agg (4/4), Betamax (joshka) (4/4), console2svg (4/4), Demo Tape (4/4), EVP (4/4), Foley (4/4), Terminalizer (4/4), termsvg (4/4), VHS (4/4) |
| `linux-pwsh` | console2svg (4/4), VHS (4/4) |
| `linux-zsh` | asciinema + agg (4/4), Betamax (joshka) (4/4), Foley (4/4), VHS (4/4) |
| `macos-zsh` | acast (4/4), asciinema + agg (4/4), Betamax (joshka) (4/4), console2svg (4/4), Demo Tape (4/4), Foley (4/4), termsvg (4/4), VHS (4/4) |
| `windows-pwsh` | console2svg (4/4) |

**Green on every declared cell and scenario:** Betamax (joshka), Demo Tape, EVP, Foley, Terminalizer, asciinema + agg, console2svg, termsvg.

**Partial coverage (working / declared cell-scenarios):** VHS (16/20), acast (8/12).

**No working GIF in CI (honest skip/broken):** PowerSession-rs + agg.
